...
const Ticket = ({ticketDetails, index, handleDelete}) =>{
    ...
    return(
        ...
        <tr>
            <td>
                <div className='ticket'>
                    ...
                    <div className='ticket_details'>
                        ...
                        <div className='ticket_items'>{ticketDetails.ticketInformation}</div>
                    </div>
                </div>
            </td>
            <td>
            ...
            <td>
                <div className='ticket_priority' style={{background:ticketDetails.ticketColor}}>
                    <p>
            ...
            <td>
                <MdDelete className='ticket_deleteButton' onClick={() => handleDelete(index)}/>
            </td>
        </tr>
