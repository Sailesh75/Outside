...
export default class Player{
    ...
    getPlayerCard()
    {
        ...
        console.log('Player Suits',playerSuits);
    }
    ...
    getScore()
    {
      const scorerank = () =>{
        ...
        console.log(playerfirstsetscore);
        console.log(playersecondsetscore);
        console.log(playerthirdsetscore);
        compareRank.getPlayerScore(playerfirstsetscore, playersecondsetscore, playerthirdsetscore);
      }
